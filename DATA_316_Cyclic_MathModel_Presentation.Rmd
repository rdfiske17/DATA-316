...
Additionally, the domain of the model is by default $[0,2\pi]$, but can be manipulated using the *b* parameter. The maximum of the function is $d + a$ and the minimum is $d - a$. The range of the model is thus contained between this maximum and minimum.
...
ggplot(suntimes,mapping=aes(x=Day,y=SunriseTime)) +
  geom_point() +
  geom_line(mapping=aes(x=Day,y=sunrise_predicted),color="red",linewidth=1)
